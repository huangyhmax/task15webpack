...
Carousel.prototype.bind=function(){
    ...
    this.$tipsBtn.on('click',function(){
        var _thistb=this
        var index=__WEBPACK_IMPORTED_MODULE_1_jquery___default()(_thistb).index();
        console.log(index);
...
var a=new Carousel(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#carousel'));
...
var curPage=1
var perPageCount=7
var liwidth=__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.item').outerWidth(true);
var waterfallarr=[]
var arrlen=parseInt(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.pic').width()/liwidth)
...
function Loaddata(){
    getData(function(newsList){
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.each(newsList,function(idx,news){
            var $nodes=getNodes(news)
            $nodes.find('img').load(function(){
                __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.pic').append($nodes)
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.loadpicture').on('click',function(){
    Loaddata()
})
/*从接口获取数据*/
...
function getNodes(item){
    ...
    return __WEBPACK_IMPORTED_MODULE_1_jquery___default()(html)
    //返回一个jquery对象
}
//瀑布流
function waterFallPlace($nodes){
    $nodes.each(function(){
        ...
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).css({
            top:waterfallarr[minIndex],
            left:__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).outerWidth(true) * minIndex, //计算包括外边距
            opacity:1
        })
        waterfallarr[minIndex] += __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).outerHeight(true);
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.pic').height(Math.max.apply(null,waterfallarr));
    })
}
...
var $portfoliowrapper=__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.portfolio-wrapper');
$portfoliowrapper.on('mouseenter','li',function(){
    console.log(1)
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).addClass('change').siblings().removeClass('change')
}).on('mouseleave','li',function(){
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).removeClass('change')
})

var $navs=__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.tipscroll>li>a'),
$sections=__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.section'),
// $window=$(window),
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).scroll(function(){
    ...
    var scrollY=__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).scrollTop();
    var len=navlength;
    // console.log('scrollTop: '+scrollTop);
    // console.log('scrollY: '+scrollY);
    if(scrollY>200){
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.navscroll').removeClass('hidden').addClass('show');
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.navbackground').removeClass('show').addClass('hidden');
    }else{
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.navscroll').removeClass('show').addClass('hidden');
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.navbackground').removeClass('hidden').addClass('show');
    }
    console.log(2)
...
$navs.on('click', function(e) {
    var scrollTop = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).scrollTop();
    console.log(1111);
    e.preventDefault();
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('html, body').animate({
        'scrollTop': __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).attr('href')).offset().top
    }, 400);
    console.log(scrollTop)
});

var $gotop=__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.gotop')
$gotop.on('click',function(){
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).scrollTop(0);
    return;
})
